                        ...
                        <div class='col-md-8 modal_body_left modal_body_left1' >
                            <div class='sap_tabs'>
                                ...
                                <div id='horizontalTab' style='display: block; width: 100%; margin: 0px;'>
                                    <button onclick='location.href='views/php/session_close.php'' class='nav_link cerrar' title='Cerrar sesión'> <i class='fas fa-sign-out-alt' style='font-size: 1.5rem'></i> <span class='nav_name'>Cerrar sesión</span></button>
                                </div>
                            </div>
                        </div>
                    </div>
