		...
		<div class="container">
			<div class="w3ls_dresses_grids">
				...
				<div class="col-md-8 w3ls_dresses_grid_right">
					...
					<?php
                                $resultados = mysqli_query($conexion, "SELECT * FROM producto WHERE ID_TipoProducto = 4");
                                while ($print = mysqli_fetch_array($resultados)) {
                                    ...
                                    <div class='hs-wrapper'>
                                        <img src='img/" . $imagen . "'  class='img-responsive' />
                                        <img src='img/" . $imagen . "'  class='img-responsive' />
                                        <img src='img/" . $imagen . "'  class='img-responsive' />
                                        <img src='img/" . $imagen . "'  class='img-responsive' />
                                        <img src='img/" . $imagen . "'  class='img-responsive' />
                                        ...
                                        <div class='w3_hs_bottom'>
                                            <ul>
                                                <li>
                                                    <a href='#' data-toggle='modal' data-target='#myModal" . $ID_Producto . "'><span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <h5><a href='single.php'>" . $tipoproducto . "</a></h5>
                                    <div class='simpleCart_shelfItem'>
                                        <p><i class='item_price'>$" . $precio . "</i></p>
                                        <p><a class='item_add' href='#'>Agregar carrito</a></p>
                                    </div>
                                    </div>
                                    <div class='modal video-modal fade' id='myModal" . $ID_Producto . "' tabindex='-1' role='dialog' aria-labelledby='myModal'>
                                    ...
                                    <div class='col-md-5 modal_body_left'>
                                        <img src='img/" . $imagen . "' alt=' ' class='img-responsive' />
                                    </div>
