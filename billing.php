...
include 'header.php';
    ...
    $DatosUsuario = mysqli_query($conexion, "SELECT * FROM datos_de_facturacion WHERE ID_Usuario = '$ID_Usuario'");
    ...
    <div class="breadcrumb_dress">
        <div class="container">
            <ul>
                ...
                <li>Editar Datos de Facturación</li>
            </ul>
        </div>
    </div>
    <!-- //breadcrumbs -->
        ...
        <div class="container">
            <form enctype="multipart/form-data" action="views/php/registros.php" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <br>
                    <button type="submit" name="ActualizarDatosDeFacturacion" value="<?php echo $ID_Usuario ?>"  class="btn btn-primary">Guardar</button>
